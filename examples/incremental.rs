...
fn main() {
    ...
    for ch in input_chars {
        ...
        println!(
            "Input: '{}' -> Output: '{}' (tone_removed: {}, letter_mod_removed: {})",
            ch,
            buffer.view(),
            result.tone_mark_removed,
            result.letter_modification_removed
        );
    }
    ...
    let _ = buffer.push('a');
    println!(
        "Input: 'a' -> Output: '{}' (circumflex added)",
        buffer.view()
    );
